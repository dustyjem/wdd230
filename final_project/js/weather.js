...
apikey = "78298f0be9d2981ef18b16cdbdb8e086"
cityid = "2347283"


const requestUrl =
    `//api.openweathermap.org/data/2.5/onecall?lat=6.${cityid}&lon=3.975647&exclude=minutely,hourly&units=imperial&appid=${apikey}`;
